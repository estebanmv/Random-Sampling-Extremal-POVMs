...
for i in range(1,10):
    yvtresm20.append((2/3)*(1-float(np.mean(vtresm20.y[(i-1)*20:i*20]))))
    xvtresm20.append((2/3)*(float(np.mean(tvtresm20[(i-1)*20:i*20]))))

xvtresm10 = []
yvtresm10 = []

for i in range(1,10):
    yvtresm10.append((1/3)*(1-float(np.mean(vtresm.y[(i-1)*10:i*10]))))
    xvtresm10.append((1/3)*(float(np.mean(tvtresm[(i-1)*10:i*10]))))

xvtresm = [sum(x) for x in zip(xvtresm20, xvtresm10)]
yvtresm = [sum(x) for x in zip(yvtresm20, yvtresm10)]

xvtnymr = []
yvtnymr = []

for i in range(1,18):
    yvtnymr.append(1-float(np.mean(vtnymr.y[(i-1)*10:i*10])))
    xvtnymr.append(float(np.mean(tvtnymr[(i-1)*10:i*10])))
...
plt.loglog(xvtresm20,yvtresm20,"b^",markersize=2)
plt.loglog(xvtcc,yvtcc,"ro",markersize=2)
